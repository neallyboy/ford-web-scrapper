...
F_SERIES_STRIPPED_CHASSIS_MANUFACTURER_URL = os.getenv("F_SERIES_STRIPPED_CHASSIS_MANUFACTURER_URL")
F_SERIES_STRIPPED_CHASSIS_MANUFACTURER_IMAGE_URL = os.getenv("F_SERIES_STRIPPED_CHASSIS_MANUFACTURER_IMAGE_URL")
F_SERIES_STRIPPED_CHASSIS_DEALER_URL = os.getenv("F_SERIES_STRIPPED_CHASSIS_DEALER_URL")
F_SERIES_STRIPPED_CHASSIS_DEALER_IMAGE_URL = os.getenv("F_SERIES_STRIPPED_CHASSIS_DEALER_IMAGE_URL")


# ------------------------------------------
# Get prices from ford.ca
# ------------------------------------------
def get_ford_mfg_f_series_stripped_chassis_prices(url: str) -> List[Tuple[str, str]]:
...
# ------------------------------------------
def get_ford_dealer_f_series_stripped_chassis_prices(url: str) -> List[Tuple[str, str]]:
...
# ------------------------------------------
def get_ford_mfg_f_series_stripped_chassis_hero_img(url: str) -> str:
...
# ------------------------------------------
def get_ford_dealer_f_series_stripped_chassis_hero_img(url: str) -> str:
...
if __name__ == "__main__":
    print(get_ford_mfg_f_series_stripped_chassis_prices(F_SERIES_STRIPPED_CHASSIS_MANUFACTURER_URL))
    print(get_ford_dealer_f_series_stripped_chassis_prices(F_SERIES_STRIPPED_CHASSIS_DEALER_URL))
    print(get_ford_mfg_f_series_stripped_chassis_hero_img(F_SERIES_STRIPPED_CHASSIS_MANUFACTURER_IMAGE_URL))
    print(get_ford_dealer_f_series_stripped_chassis_hero_img(F_SERIES_STRIPPED_CHASSIS_DEALER_IMAGE_URL))
