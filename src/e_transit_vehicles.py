...
E_TRANSIT_MANUFACTURER_URL = os.getenv("E_TRANSIT_MANUFACTURER_URL")
E_TRANSIT_MANUFACTURER_IMAGE_URL = os.getenv("E_TRANSIT_MANUFACTURER_IMAGE_URL")
E_TRANSIT_DEALER_URL = os.getenv("E_TRANSIT_DEALER_URL")
E_TRANSIT_DEALER_IMAGE_URL = os.getenv("E_TRANSIT_DEALER_IMAGE_URL")


# ------------------------------------------
# Get prices from ford.ca
# ------------------------------------------
def get_ford_mfg_e_transit_prices(url: str) -> List[Tuple[str, str]]:
...
# ------------------------------------------
def get_ford_dealer_e_transit_prices(url: str) -> List[Tuple[str, str]]:
...
# ------------------------------------------
def get_ford_mfg_e_transit_hero_img(url: str) -> str:
...
# ------------------------------------------
def get_ford_dealer_e_transit_hero_img(url: str) -> str:
...
if __name__ == "__main__":
    print(get_ford_mfg_e_transit_prices(E_TRANSIT_MANUFACTURER_URL))
    print(get_ford_dealer_e_transit_prices(E_TRANSIT_DEALER_URL))
    print(get_ford_mfg_e_transit_hero_img(E_TRANSIT_MANUFACTURER_IMAGE_URL))
    print(get_ford_dealer_e_transit_hero_img(E_TRANSIT_DEALER_IMAGE_URL))
