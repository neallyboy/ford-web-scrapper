...
SUPER_DUTY_COMMERCIAL_MANUFACTURER_URL = os.getenv("SUPER_DUTY_COMMERCIAL_MANUFACTURER_URL")
SUPER_DUTY_COMMERCIAL_MANUFACTURER_IMAGE_URL = os.getenv("SUPER_DUTY_COMMERCIAL_MANUFACTURER_IMAGE_URL")
SUPER_DUTY_COMMERCIAL_DEALER_URL = os.getenv("SUPER_DUTY_COMMERCIAL_DEALER_URL")
SUPER_DUTY_COMMERCIAL_DEALER_IMAGE_URL = os.getenv("SUPER_DUTY_COMMERCIAL_DEALER_IMAGE_URL")


# ------------------------------------------
# Get prices from ford.ca
# ------------------------------------------
def get_ford_mfg_super_duty_commercial_prices(url: str) -> List[Tuple[str, str]]:
    ...
    while True:
        try:
            ...
            button = driver.find_element(
                By.XPATH,
                '//div[@id="component04"]//button[contains(@class,"fgx-btn to-fade-in carousel-btn carousel-arrow carousel-next scrollable")]',
            )
            ...
            # Decrement the exit count, if it reaches 0, raise an exception
            exit_count -= 1
            if exit_count == 0:
                raise Exception(f"Exit count reached 0 - infinite loop detected.")
...
# ------------------------------------------
def get_ford_dealer_super_duty_commercial_prices(url: str) -> List[Tuple[str, str]]:
...
# ------------------------------------------
def get_ford_mfg_super_duty_commercial_hero_img(url: str) -> str:
...
# ------------------------------------------
def get_ford_dealer_super_duty_commercial_hero_img(url: str) -> str:
...
if __name__ == "__main__":
    print(get_ford_mfg_super_duty_commercial_prices(SUPER_DUTY_COMMERCIAL_MANUFACTURER_URL))
    print(get_ford_dealer_super_duty_commercial_prices(SUPER_DUTY_COMMERCIAL_DEALER_URL))
    print(get_ford_mfg_super_duty_commercial_hero_img(SUPER_DUTY_COMMERCIAL_MANUFACTURER_IMAGE_URL))
    print(get_ford_dealer_super_duty_commercial_hero_img(SUPER_DUTY_COMMERCIAL_DEALER_IMAGE_URL))
