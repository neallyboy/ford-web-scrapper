...
TRANSIT_COMMERCIAL_MANUFACTURER_URL = os.getenv("TRANSIT_COMMERCIAL_MANUFACTURER_URL")
TRANSIT_COMMERCIAL_MANUFACTURER_IMAGE_URL = os.getenv("TRANSIT_COMMERCIAL_MANUFACTURER_IMAGE_URL")
TRANSIT_COMMERCIAL_DEALER_URL = os.getenv("TRANSIT_COMMERCIAL_DEALER_URL")
TRANSIT_COMMERCIAL_DEALER_IMAGE_URL = os.getenv("TRANSIT_COMMERCIAL_DEALER_IMAGE_URL")


# ------------------------------------------
# Get prices from ford.ca
# ------------------------------------------
def get_ford_mfg_transit_commercial_prices(url: str) -> List[Tuple[str, str]]:
...
# ------------------------------------------
def get_ford_dealer_transit_commercial_prices(url: str) -> List[Tuple[str, str]]:
...
# ------------------------------------------
def get_ford_mfg_transit_commercial_hero_img(url: str) -> str:
...
# ------------------------------------------
def get_ford_dealer_transit_commercial_hero_img(url: str) -> str:
...
if __name__ == "__main__":
    print(get_ford_mfg_transit_commercial_prices(TRANSIT_COMMERCIAL_MANUFACTURER_URL))
    print(get_ford_dealer_transit_commercial_prices(TRANSIT_COMMERCIAL_DEALER_URL))
    print(get_ford_mfg_transit_commercial_hero_img(TRANSIT_COMMERCIAL_MANUFACTURER_IMAGE_URL))
    print(get_ford_dealer_transit_commercial_hero_img(TRANSIT_COMMERCIAL_DEALER_IMAGE_URL))
