...
TRANSIT_CC_CA_MANUFACTURER_URL = os.getenv("TRANSIT_CC_CA_MANUFACTURER_URL")
TRANSIT_CC_CA_MANUFACTURER_IMAGE_URL = os.getenv("TRANSIT_CC_CA_MANUFACTURER_IMAGE_URL")
TRANSIT_CC_CA_DEALER_URL = os.getenv("TRANSIT_CC_CA_DEALER_URL")
TRANSIT_CC_CA_DEALER_IMAGE_URL = os.getenv("TRANSIT_CC_CA_DEALER_IMAGE_URL")


# ------------------------------------------
# Get prices from ford.ca
# ------------------------------------------
def get_ford_mfg_transit_cc_ca_prices(url: str) -> List[Tuple[str, str]]:
...
# ------------------------------------------
def get_ford_dealer_transit_cc_ca_prices(url: str) -> List[Tuple[str, str]]:
...
# ------------------------------------------
def get_ford_mfg_transit_cc_ca_hero_img(url: str) -> str:
...
# ------------------------------------------
def get_ford_dealer_transit_cc_ca_hero_img(url: str) -> str:
...
if __name__ == "__main__":
    print(get_ford_mfg_transit_cc_ca_prices(TRANSIT_CC_CA_MANUFACTURER_URL))
    print(get_ford_dealer_transit_cc_ca_prices(TRANSIT_CC_CA_DEALER_URL))
    print(get_ford_mfg_transit_cc_ca_hero_img(TRANSIT_CC_CA_MANUFACTURER_IMAGE_URL))
    print(get_ford_dealer_transit_cc_ca_hero_img(TRANSIT_CC_CA_DEALER_IMAGE_URL))
