...
F150_COMMERCIAL_MANUFACTURER_URL = os.getenv("F150_COMMERCIAL_MANUFACTURER_URL")
F150_COMMERCIAL_MANUFACTURER_IMAGE_URL = os.getenv(
    "F150_COMMERCIAL_MANUFACTURER_IMAGE_URL"
)
F150_COMMERCIAL_DEALER_URL = os.getenv("F150_COMMERCIAL_DEALER_URL")
F150_COMMERCIAL_DEALER_IMAGE_URL = os.getenv("F150_COMMERCIAL_DEALER_IMAGE_URL")


# ------------------------------------------
# Get prices from ford.ca
# ------------------------------------------
def get_ford_mfg_f150_commercial_prices(url: str) -> List[Tuple[str, str]]:
...
# ------------------------------------------
def get_ford_dealer_f150_commercial_prices(url: str) -> List[Tuple[str, str]]:
...
# ------------------------------------------
def get_ford_mfg_f150_commercial_hero_img(url: str) -> str:
...
# ------------------------------------------
def get_ford_dealer_f150_commercial_hero_img(url: str) -> str:
...
if __name__ == "__main__":
    print(get_ford_mfg_f150_commercial_prices(F150_COMMERCIAL_MANUFACTURER_URL))
    print(get_ford_dealer_f150_commercial_prices(F150_COMMERCIAL_DEALER_URL))
    print(get_ford_mfg_f150_commercial_hero_img(F150_COMMERCIAL_MANUFACTURER_IMAGE_URL))
    print(get_ford_dealer_f150_commercial_hero_img(F150_COMMERCIAL_DEALER_IMAGE_URL))
