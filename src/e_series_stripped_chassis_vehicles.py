...
E_SERIES_STRIPPED_CHASSIS_MANUFACTURER_URL = os.getenv("E_SERIES_STRIPPED_CHASSIS_MANUFACTURER_URL")
E_SERIES_STRIPPED_CHASSIS_MANUFACTURER_IMAGE_URL = os.getenv("E_SERIES_STRIPPED_CHASSIS_MANUFACTURER_IMAGE_URL")
E_SERIES_STRIPPED_CHASSIS_DEALER_URL = os.getenv("E_SERIES_STRIPPED_CHASSIS_DEALER_URL")
E_SERIES_STRIPPED_CHASSIS_DEALER_IMAGE_URL = os.getenv("E_SERIES_STRIPPED_CHASSIS_DEALER_IMAGE_URL")
...
if __name__ == "__main__":
    print(get_ford_mfg_e_series_stripped_chassis_prices(E_SERIES_STRIPPED_CHASSIS_MANUFACTURER_URL))
    print(get_ford_dealer_e_series_stripped_chassis_prices(E_SERIES_STRIPPED_CHASSIS_DEALER_URL))
    print(get_ford_mfg_e_series_stripped_chassis_hero_img(E_SERIES_STRIPPED_CHASSIS_MANUFACTURER_IMAGE_URL))
    print(get_ford_dealer_e_series_stripped_chassis_hero_img(E_SERIES_STRIPPED_CHASSIS_DEALER_IMAGE_URL))
