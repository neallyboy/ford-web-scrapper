...
TRANSIT_CONNECT_MANUFACTURER_URL = os.getenv("TRANSIT_CONNECT_MANUFACTURER_URL")
TRANSIT_CONNECT_MANUFACTURER_IMAGE_URL = os.getenv("TRANSIT_CONNECT_MANUFACTURER_IMAGE_URL")
TRANSIT_CONNECT_DEALER_URL = os.getenv("TRANSIT_CONNECT_DEALER_URL")
TRANSIT_CONNECT_DEALER_IMAGE_URL = os.getenv("TRANSIT_CONNECT_DEALER_IMAGE_URL")


# ------------------------------------------
# Get prices from ford.ca
# ------------------------------------------
def get_ford_mfg_transit_connect_prices(url: str) -> List[Tuple[str, str]]:
...
# ------------------------------------------
def get_ford_dealer_transit_connect_prices(url: str) -> List[Tuple[str, str]]:
...
# ------------------------------------------
def get_ford_mfg_transit_connect_hero_img(url: str) -> str:
...
# ------------------------------------------
def get_ford_dealer_transit_connect_hero_img(url: str) -> str:
...
if __name__ == "__main__":
    print(get_ford_mfg_transit_connect_prices(TRANSIT_CONNECT_MANUFACTURER_URL))
    print(get_ford_dealer_transit_connect_prices(TRANSIT_CONNECT_DEALER_URL))
    print(get_ford_mfg_transit_connect_hero_img(TRANSIT_CONNECT_MANUFACTURER_IMAGE_URL))
    print(get_ford_dealer_transit_connect_hero_img(TRANSIT_CONNECT_DEALER_IMAGE_URL))
