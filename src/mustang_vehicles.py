...
# ------------------------------------------
def get_ford_mfg_mustang_prices() -> List[Tuple[str, str]]:
...
# ------------------------------------------
def get_ford_dealer_mustang_prices() -> List[Tuple[str, str]]:
...
# ------------------------------------------
def get_ford_mfg_mustang_hero_img() -> str:
...
# ------------------------------------------
def get_ford_dealer_mustang_hero_img() -> str:
