...
F650_F750_MANUFACTURER_URL = os.getenv("F650_F750_MANUFACTURER_URL")
F650_F750_MANUFACTURER_IMAGE_URL = os.getenv("F650_F750_MANUFACTURER_IMAGE_URL")
F650_F750_DEALER_URL = os.getenv("F650_F750_DEALER_URL")
F650_F750_DEALER_IMAGE_URL = os.getenv("F650_F750_DEALER_IMAGE_URL")


# ------------------------------------------
# Get prices from ford.ca
# ------------------------------------------
def get_ford_mfg_f650_f750_prices(url: str) -> List[Tuple[str, str]]:
...
# ------------------------------------------
def get_ford_dealer_f650_f750_prices(url: str) -> List[Tuple[str, str]]:
...
# ------------------------------------------
def get_ford_mfg_f650_f750_hero_img(url: str) -> str:
...
# ------------------------------------------
def get_ford_dealer_f650_f750_hero_img(url: str) -> str:
...
if __name__ == "__main__":
    print(get_ford_mfg_f650_f750_prices(F650_F750_MANUFACTURER_URL))
    print(get_ford_dealer_f650_f750_prices(F650_F750_DEALER_URL))
    print(get_ford_mfg_f650_f750_hero_img(F650_F750_MANUFACTURER_IMAGE_URL))
    print(get_ford_dealer_f650_f750_hero_img(F650_F750_DEALER_IMAGE_URL))
